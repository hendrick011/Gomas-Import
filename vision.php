...
<section class="marcas">
  <h2 class="section__titulo">Vision</h2>
    <p class="section__texto">Ser líderes por excelencia en el mercado nacional,
       caracterizados esencialmente por nuestro alto sentido se competitividad, servicio,
        estándares de calidad, contribuyendo significativamente con el crecimiento y el
         desarrollo progresivo junto a nuestros clientes.</p>
</section>
