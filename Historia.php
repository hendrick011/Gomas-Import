...
<section class="marcas">
  <h2 class="section__titulo">Historia</h2>
    <p class="section__texto">Gomas Import es una empresa con más de 20 años de experiencia
      en la venta de gomas nuevas y usadas, lubricantes, baterías y accesorios para
      vehículos de motor. Todo al por mayor y al detalle.

Nuestra gama de productos es amplia, ofrecemos neumáticos para todo tipo de vehículos,
además neumáticos industriales y agrícolas.

Baterías para todo tipo de vehículos, camiones y equipos pesados, también baterías de
inversores de las mejores marcas y a los mejores precios.</p>
</section>
<!----------------------pie--------------------->
