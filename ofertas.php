...
<main class="main">
  <div class="contenedor">
    <section class="anuncios">
      <article class="anuncios__columna">
        <img src="img/img8.jpg" alt="" class="anuncios__img" width="750" height="400">
      </article>

     <article class="anuncios__columna">
       <img src="img/img9.jpg" alt="" class="anuncios__img" width="750" height="400">
   </article>

       <article class="anuncios__columna">
         <img src="img/img17.jpg" alt="" class="anuncios__img" width="750" height="400">
       </article>

         <article class="anuncios__columna">
           <img src="img/img18.png" alt="" class="anuncios__img" width="750" height="400">
         </article>
       </section>
