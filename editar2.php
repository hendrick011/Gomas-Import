...
$registros=mysqli_query($conexion,"select * from tbcontactos
                        where cedula='$_REQUEST[cedula]' and nombre='$_REQUEST[nombre]' ") or
...
<br>
<br>
<input type="text" name="cednueva" value="<?php echo $reg['cedula'] ?>">
<input type="hidden" name="cedvieja" value="<?php echo $reg['cedula'] ?>">
<br>
<br>
Ingrese nuevo nombre:
<br>
<br>
<input type="text" name="nomnueva" value="<?php echo $reg['nombre'] ?>">
<input type="hidden" name="nomvieja" value="<?php echo $reg['nombre'] ?>">
...
<?php
  ...
  echo "No existe contacto con dicha cedula o nombre";
?>
<footer class="footer">
  <div class="social">
