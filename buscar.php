...
$registros=mysqli_query($conexion,"select cedula, nombre, apellidos, compania, posicion, email, telefono, notas
                        from tbcontactos where nombre='$_REQUEST[nombre]' ") or
...
if ($reg=mysqli_fetch_array($registros))
{
  ...
  echo "Compania: ".$reg['compania']."<br>";
  echo "Posicion: ".$reg['posicion']."<br>";
  echo "Email: ".$reg['email']."<br>";
  echo "Nombre: ".$reg['telefono']."<br>";
  echo "Nombre: ".$reg['notas']."<br>";
}
else
{
  echo "No existe un contacto con esa cedula o nombre.";
}
