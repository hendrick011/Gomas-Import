...
mysqli_query($conexion,"insert into tbcontactos (cedula, nombre, apellidos, compania, posicion, email, telefono, notas) values
                       ('$_REQUEST[cedula]','$_REQUEST[nombre]','$_REQUEST[apellidos]','$_REQUEST[compania]','$_REQUEST[posicion]','$_REQUEST[email]','$_REQUEST[telefono]','$_REQUEST[notas]')")
